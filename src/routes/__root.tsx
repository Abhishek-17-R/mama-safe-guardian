...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-powered maternal health risk assessment from hospital reports. Empowering safer pregnancies." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "MatriCare — AI Maternal Health Risk Prediction" },
      { name: "twitter:description", content: "AI-powered maternal health risk assessment from hospital reports. Empowering safer pregnancies." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/98a29e6f-8d72-431f-b991-e2c5dbd44590" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/98a29e6f-8d72-431f-b991-e2c5dbd44590" },
    ],
    links: [
